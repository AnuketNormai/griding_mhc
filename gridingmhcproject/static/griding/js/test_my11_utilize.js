      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          am4core.ready(function() {
            ...
            var capacity = 100;
            var value = utilize[10];
            var circleSize = 0.8;
            
            var component = am4core.create("chartutilizeMY11", am4core.Container)
            ...
            label.text = formattedValue + " percent";
            ...
            capacityLabel.text = "Max Utilize " + formattedCapacity + " %";
